...
The code repository is public at https://github.com/vicenzoscavino1999/surfaceome-gastric-cancer. The frozen reproducibility data package for release candidate `v0.1.0-rc4` is archived through Zenodo at https://zenodo.org/records/20498705 with DOI `10.5281/zenodo.20498705`. The archival DOI covers the frozen data inputs needed for the reviewer contract, with checksum manifests and exact retrieval/provenance records where upstream redistribution terms require source-specific handling.
