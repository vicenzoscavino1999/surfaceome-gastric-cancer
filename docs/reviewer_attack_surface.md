...
| RA-03 | TCGA/GTEx batch invalidates selectivity. | High | Xena/Toil planned as primary; adjacent-normal sensitivity planned. | No PCA/PERMANOVA yet. | Generate PCA/PERMANOVA before freezing `N`. |
