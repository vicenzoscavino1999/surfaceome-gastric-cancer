...
[![Reproducibility CI](https://github.com/vicenzoscavino1999/surfaceome-gastric-cancer/actions/workflows/reproducibility-ci.yml/badge.svg)](https://github.com/vicenzoscavino1999/surfaceome-gastric-cancer/actions/workflows/reproducibility-ci.yml)
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20498705.svg)](https://doi.org/10.5281/zenodo.20498705)
...
Public repository: https://github.com/vicenzoscavino1999/surfaceome-gastric-cancer. The final code release tag is `v0.1.7`; the frozen `v0.1.0-rc4` data/raw bundle is archived on Zenodo at https://zenodo.org/records/20498705 with DOI `10.5281/zenodo.20498705`.
