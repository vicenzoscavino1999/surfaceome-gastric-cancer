...
Public repository: https://github.com/vicenzoscavino1999/surfaceome-gastric-cancer. The planned release-candidate tag is `v0.1.0-rc1`; the archival DOI remains pending until the frozen data/raw bundle or equivalent checksum/provenance package is deposited externally.
