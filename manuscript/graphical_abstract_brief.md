...
## Required by target journal

Computational Biology and Chemistry requires a graphical abstract as a separate submission file. Elsevier's journal guide lists a minimum image size of 531 x 1328 pixels (h x w) or proportionally larger; the general Elsevier graphical-abstract guidance gives the same ratio as 1328 x 531 pixels (w x h). Preferred file types include TIFF, EPS, PDF, or MS Office files.
...
- Do not present candidates as clinically established.
- Use "hypothesis-generating" or "prioritized candidates".
- Show GPI correction as a method insight, not a target-specific rescue.
- Keep Tier 1 unordered.
- Include a small limitations strip: bulk RNA, TME, isoforms, HPA IHC, no wet-lab validation.
...
- Editable vector source: `manuscript/graphical_abstract.svg`.
- Separate CBC submission file: `manuscript/graphical_abstract.tiff`.
- Visual-review raster: `manuscript/graphical_abstract_preview.png`.
- Export dimensions: 3200 x 1280 pixels (w x h), above the Elsevier/CBC minimum.
- Artwork source is deterministic SVG, not AI-generated artwork.
- Visual review completed on 2026-05-31: no cropped text or overlapping elements.
