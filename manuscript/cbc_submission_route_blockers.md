...
- Public repository, final code release, and DOI: resolved for this draft. The public repository URL is https://github.com/vicenzoscavino1999/surfaceome-gastric-cancer, with final code release tag `v0.1.2`. The frozen reproducibility data package is archived on Zenodo at https://zenodo.org/records/20498705 with DOI `10.5281/zenodo.20498705`, covering the frozen input bundle and checksum/provenance data package.
