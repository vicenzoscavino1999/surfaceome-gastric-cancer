...
- Public repository and DOI: publish the repository/release package and archive it with Zenodo, OSF, or Figshare before submission. Insert both URL and DOI in the manuscript and cover letter. The DOI must cover the frozen input bundle or an equivalent checksum/provenance data package for inputs that cannot be redistributed.
