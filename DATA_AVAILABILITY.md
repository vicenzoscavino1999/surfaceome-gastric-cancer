...
The code repository is public at https://github.com/vicenzoscavino1999/surfaceome-gastric-cancer. The final code release tag is `v0.1.2`. The frozen reproducibility data package for release candidate `v0.1.0-rc4` is archived on Zenodo at https://zenodo.org/records/20498705 with DOI `10.5281/zenodo.20498705`.
